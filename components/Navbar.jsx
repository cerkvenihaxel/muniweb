    ...
    <Popover className=" bg-primary relative">
      <div className="flex items-center justify-between px-4 py-2 sm:px-6 md:justify-start md:space-x-10">
        ...
        <div className="-my-2 -mr-2 md:hidden">
          <Popover.Button className="inline-flex items-center justify-center rounded-md bg-secondary p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <Popover className="relative">
            {({ open }) => (
              <>
                ...
                >
                  <Popover.Panel className="absolute z-10 -ml-4 mt-3 bg-secondary w-screen max-w-md transform lg:left-1/2 lg:ml-0 lg:max-w-2xl lg:-translate-x-1/2">
                    <div className="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                      <div className="relative grid gap-6 bg-secondary text-black px-5 py-6 sm:gap-8 sm:p-8 lg:grid-cols-2">
